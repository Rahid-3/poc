...
function set_pagenation_button(total_page,record_count,sr_start,sr_end){
    ...
    // previous
    if(current_page==1) {
        out+='<li class="prev disabled" aria-disabled="true"><a class="btn btn-dark" href="javascript:;"><i class="fa fa-arrow-left"></i></a></li>';
    } else if(current_page==2){
        out+='<li class="prev"><a class="btn btn-dark" data-page="1" href="javascript:;"><i class="fa fa-arrow-left"></i></a></li>';
    } else {
        out+='<li class="prev"><a class="btn btn-dark" data-page="'+(current_page-1)+'" href="javascript:;"><i class="fa fa-arrow-left"></i></a></li>';
    }
    ...
    if(current_page<total_page) {
        out+='<li class="next"><a class="btn btn-dark" data-page="'+(current_page+1)+'" href="javascript:;"><i class="fa fa-arrow-right"></i></a></li>';
    } else {
        out+='<li class="next disabled" aria-disabled="true"><a class="btn btn-dark" href="javascript:;"><i class="fa fa-arrow-right"></i></a></li>';
    }
...
$.fn.InexDataTable = function(url,csrf_token,filter_ids_arr,function_before_ajax,function_after_ajax) {
    ...
    _this.prepend('<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="pagination_footer_buttons" align="center"></div>');        //this div is for table data
    _this.prepend('<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="pagination_main"></div>');        //this div is for table data
    _this.prepend('<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="pagination_data_div"></div>');    //this div is for hidden-element, search-box, select-row
    var html = '';
